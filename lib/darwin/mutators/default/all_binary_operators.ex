...
#     operator_ex = Keyword.get(mutator, :operator_ex)
#     operator_erl = Keyword.get(mutator, :operator)
#     operator_for_docs = operator_ex || operator_erl
...
#   @doc false
#   def abstract_code_less_than({:op, line, _op, a, b}), do: {:op, line, :<, a, b}
#   @doc false
#   def abstract_code_less_than_or_equal_to({:op, line, _op, a, b}), do: {:op, line, :"=<", a, b}
#   @doc false
#   def abstract_code_equal_to({:op, line, _op, a, b}), do: {:op, line, :==, a, b}
#   @doc false
#   def abstract_code_not_equal_to({:op, line, _op, a, b}), do: {:op, line, :"/=", a, b}
#   @doc false
#   def abstract_code_greater_than_or_equal_to({:op, line, _op, a, b}), do: {:op, line, :>=, a, b}
#   @doc false
#   def abstract_code_greater_than({:op, line, _op, a, b}), do: {:op, line, :>, a, b}
...
#   @less_than_fs_pair {:runtime_less_than, :abstract_code_less_than}
...
#     abstract_code_mfa: {BinOpMutatorCreator, :abstract_code_less_than, []}
#   ],
#   [
...
#     abstract_code_mfa: {BinOpMutatorCreator, :abstract_code_equal_to, []}
#   ],
#   [
...
#     abstract_code_mfa: {BinOpMutatorCreator, :abstract_code_not_equal_to, []}
#   ],
#   [
