defmodule Darwin.Mutator.Rewriters.ClauseRewriterWithVariableShadowing do
  ...
  @external_resource "lib/darwin/mutator/rewriters/templates/shadowed/clause_with_guards.hrl"
  @external_resource "lib/darwin/mutator/rewriters/templates/shadowed/clause_without_guards.hrl"
  ...
  defp clause_with_guards_to_function(clause, ctx) do
    ...
    mutated_abstract_code =
      Erlang.interpolate_in_abstract_code!(
        ...
        File.read!("lib/darwin/mutator/rewriters/templates/shadowed/clause_with_guards.hrl"),
  ...
  defp clause_without_guards_to_function(clause, ctx) do
    ...
    mutated_abstract_code =
      Erlang.interpolate_in_abstract_code!(
        File.read!("lib/darwin/mutator/rewriters/templates/shadowed/clause_without_guards.hrl"),
        DummyArgument: dummy_argument,
        PatternTuple: pattern_tuple,
        Body: block
      )
